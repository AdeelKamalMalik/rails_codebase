class SubscriptionsController < ApplicationController
  ...
  def update
    ...
    redirect_to account_settings_path(tab: 4), notice: t(".success")
  rescue Pay::ActionRequired => e
    redirect_to pay.payment_path(e.payment.id)
  rescue Pay::Error => e
    edit # Reload plans
  ...
  def billing_settings
    ...
    redirect_to account_settings_path(tab: 4), notice: t(".billing_settings_updated")
  end
  ...
  def set_subscription
    ...
    redirect_to account_settings_path(tab: 4) if @subscription.nil?
  end

  def redirect_if_already_subscribed
    if current_account.payment_processor&.subscribed?
      redirect_to root_path, alert: t(".already_subscribed")
    end
  end
