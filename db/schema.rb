...
ActiveRecord::Schema[7.1].define(version: 2024_07_26_043448) do
  ...
  create_table "contract_files", force: :cascade do |t|
    ...
    t.decimal "acv", precision: 12, scale: 2
    t.decimal "tcv", precision: 12, scale: 2
    t.index ["contract_id"], name: "index_contract_files_on_contract_id"
  end
  ...
  create_table "contracts", force: :cascade do |t|
    ...
    t.integer "review_input", default: 0, null: false
    t.integer "vendor_id"
    t.decimal "annual_cost", precision: 12, scale: 2
    ...
    t.index ["public_id"], name: "index_contracts_on_public_id", unique: true
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.decimal "sales_tax", precision: 12, scale: 2
  ...
  create_table "vendors", force: :cascade do |t|
    ...
    t.datetime "end_date"
    t.string "vendor_url"
    t.index ["public_id"], name: "index_vendors_on_public_id", unique: true
  end
